...
function AppContent() {
  ...
  // This function now handles both opening and closing
  const toggleSidebar = () => setSidebarOpen(!isSidebarOpen);
  
  // This function is specifically for closing (used by the overlay)
  ...
  return (
    <div className="app-container">
      ...
      {/* --- NEW: Overlay for closing the sidebar on mobile --- */}
