  ...
  return (
    <>
      ...
      <aside className={`sidebar ${dark ? 'dark' : 'light'} ${isOpen ? 'open' : ''}`}>
        ...
        <header className="sidebar-header">
          <span /> {/* This is your left spacer from the original grid */}
        ...
        <nav className="sidebar-nav" onClick={handleLinkClick}>
          {/* Your NavLink structure remains untouched */}
            ...
            {show(PERMANENT_SHIFT_ROLES) && (<NavLink to="/admin/permanent-shifts" className={linkClass}><FaLayerGroup /> Manage Permanent Shifts</NavLink>)}
