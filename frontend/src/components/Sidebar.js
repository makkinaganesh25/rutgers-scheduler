...
// import { listAnnouncements } from '../api'; // This line is removed to prevent build errors
import {
  SUPERVISOR_ROLES,
  EVENT_CREATOR_ROLES,
  ADMIN_USER_ROLES,
...
export default function Sidebar({ isOpen, toggleSidebar }) {
  ...
  // The state and useEffect for announcement count have been removed to prevent build errors.
  ...
  return (
    <>
      {/* --- This button is now OUTSIDE the sidebar for mobile --- */}
