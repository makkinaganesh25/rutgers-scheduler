...
// We now accept isOpen and toggleSidebar as props
export default function Sidebar({ isOpen, toggleSidebar }) {
  ...
  useEffect(() => {
    // If this causes a build error, we must remove it.
    // For now, we keep it as it was in your working version.
    listAnnouncements()
  ...
  return (
    // Add the 'is-open' class when the sidebar should be visible on mobile
